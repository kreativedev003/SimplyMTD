...
namespace SimplyMTD.Controllers
{
    public partial class UploadController : Controller
    {
        ...
        [HttpPost("upload/obligation")]
        public async Task<IActionResult> Obligation(IFormFile file, IFormCollection data)
        {
            try
            {
				...
				string periodKey = data["periodKey"].ToString();
				await this._MTDService.setAttach(periodKey, file.FileName);
